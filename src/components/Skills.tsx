        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-8">
            {skills.map((skill, index) => (
              <div key={skill.name} className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 text-center">
              ...
              <p className="text-gray-300 text-sm">Creating compelling visual stories from complex datasets</p>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-blue-400 mb-2">Statistical Analysis</h3>
              <p className="text-gray-300 text-sm">Advanced statistical methods and predictive modeling</p>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-blue-400 mb-2">Business Intelligence</h3>
              <p className="text-gray-300 text-sm">Transforming data into actionable business insights</p>
            </div>
          </div>
        </div>
      </div>
